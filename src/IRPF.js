...
export class IRPF {
  ...
  get totalDeducoes() {
    ...
    totalDeducoes += this.contribuicaoPrevidenciaria.reduce(
      (sum, contribuicao) => {
  ...
  get imposto() {
    ...
    if (this.baseCalculo <= 2826.65) return 0.075 * (this.baseCalculo - 142.8);

    if (this.baseCalculo <= 3751.05) return 0.15 * (this.baseCalculo - 354.8);
